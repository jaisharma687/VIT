public class AESRound1 {
    ...
    private static final int[][] SBox = {
        ...
        {0xE1, 0xF8, 0x98, 0x11, 0x69, 0xD9, 0x8E, 0x94, 0x9B, 0x87, 0xE9, 0xCE, 0x55, 0x28, 0xDF, 0x8C},
        {0xA1, 0x89, 0x0D, 0xBF, 0xE6, 0x42, 0x68, 0x41, 0x99, 0x2D, 0x0F, 0xB0, 0x54, 0xBB, 0x16, 0x16}
    };

    private static final int[][] MixColMat = {
        {0x02, 0x03, 0x01, 0x01},
        {0x01, 0x02, 0x03, 0x01},
        {0x01, 0x01, 0x02, 0x03},
        {0x03, 0x01, 0x01, 0x02}
    ...
    private static void MixColumns(int[][] state) {
        ...
        for (int c = 0; c < 4; c++) {
            for (int r = 0; r < 4; r++) {
                temp[r][c] = gmul(MixColMat[r][0], state[0][c]) ^
                             gmul(MixColMat[r][1], state[1][c]) ^
                             gmul(MixColMat[r][2], state[2][c]) ^
                             gmul(MixColMat[r][3], state[3][c]);
            }
        }
    ...
    public static void main(String[] args) {
        // Given plaintext and key matrices
        int[][] state = {
            {0x00, 0x00, 0x01, 0x00},
            {0x02, 0x03, 0x03, 0x04},
            {0x04, 0x06, 0x06, 0x08},
        ...
        System.out.println("State after Round 1 MixColumns:");
